...
<div class="row">
             ...
             <div class="d-flex flex-wrap align-items-center justify-content-between">
                <div class="d-flex flex-wrap align-items-center">
                   ...
                   <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                      {{-- <h4 class="me-2 h4">{{ $data->name ?? 'Austin Robertson'  }}</h4> --}}
                      <h4 class="mb-0 caption-title">{{ auth()->user()->name ?? 'Austin Robertson'  }}</h4>
                      <span class="text-capitalize"> - {{ str_replace('_',' ',auth()->user()->role) ?? 'Marketing Administrator' }}</span>
                   </div>
                </div>
   ...
   @include('components.share-offcanvas')
@endsection
