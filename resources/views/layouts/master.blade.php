...
<body>
    {{-- Bagian untuk Loader (Opsional, jika ingin digunakan) --}}
    {{-- <div id="loading">
        @include('components._body_loader')
    </div> --}}

    {{-- Sidebar --}}
    @include('components._body_sidebar')

    {{-- Main Content --}}
    <main class="main-content">
        <div class="position-relative">
            @include('components._body_header')
            @include('components.sub-header')
        </div>

        {{-- Bagian untuk Konten Unik Tiap Halaman --}}
        <div class="conatiner-fluid content-inner mt-n5 py-0">
            @yield('content')
        </div>

        @include('components._body_footer')
    </main>
